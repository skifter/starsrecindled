  ...
  const systems: StarSystem[] = serverSystems.map((system) => {
    ...
    const fleets = serverFleets
      ...
      .map((fleet) => ({
        ...
        legacyColonizationCapacity: fleet.legacyColonizationCapacity,
        composition: fleet.composition,
        refit: fleet.refit ?? null,
    ...
    return {
      ...
      resourcePotential: system.resourcePotential,
      asteroids: system.asteroids,
      resourceOutput: system.resourceOutput,
